...
body_t *create_earth(void) {
    ...
    return new_orbiting(perihelion, aphelion, mass_solar, earth_au_radius,
                        BLUE, "Earth");
}
...
body_t *create_moon(body_t *b){
    ...
    return new_orbiting_child(b, perihelion, aphelion, mass_solar, moon_au_radius, LIGHTGRAY, "Moon");
}
